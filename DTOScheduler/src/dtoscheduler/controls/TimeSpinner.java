...
// The follow TimeSpinner class was borrowed from the following location:
...
public class TimeSpinner extends Spinner<LocalTime>
{
    ...
    private final ObjectProperty<String> pattern = new SimpleObjectProperty<>("HH:mm:ss");
    ...
    public ObjectProperty<String> patternProperty()
    {
        return pattern;
    }
